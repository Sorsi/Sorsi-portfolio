		...
		return (
			<div className="about-container">
				...
				<p id="intro">
					...
					Now I'm a Full Stack Web Developer using MEAN (MongoDB, Express.js,
					AngularJS, and Node.js) or MERN (MongoDB, Express, React, Node.js)
					stack,Redux, RESTful APIs, MySQL/PostgreSQL, Lodash, Express,
